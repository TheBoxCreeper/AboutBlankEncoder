const config = [
	...
	{name: 'enc-acc-icon' , value: '' }, /* New Tab Icon. Use a url from the encoder's point of view. Example: 'favicons/Google Slides.png'*/
	{name: 'enc-new-search' , value: true }, /* Make the search on the new tab page functional. Boolean*/
	{name: 'enc-html-insertion' , value: false }, /* Enable the option to insert html. Boolean*/
];
